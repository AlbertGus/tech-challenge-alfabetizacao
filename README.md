...
# Quarentena (DLQ): Regras de validação verificam a integridade das chaves (ex: id\_municipio). Registros malformados no Streaming não quebram o pipeline; são roteados para um bucket de Quarentena (/quarentena/streaming\_falhas/) para futura auditoria.
